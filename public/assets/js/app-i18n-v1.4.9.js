...
(function () {
    ...
    const EN = {
        ...
        "用 90 秒认识 RestCal": "Meet RestCal in 90 seconds", "只看最常用的操作，边看边试，不会保存演示记录。": "Try the essential actions as you go. No demo records will be saved.",
        "引导内容": "Tour topics", "记录与统计": "Records and insights", "工资与工具": "Pay and tools", "本地与备份": "Local data and backup",
        ...
        "日历工作台": "Calendar workspace", "记录": "Records", "工具箱": "Toolbox", "个性化": "Personalize", "安全与偏好": "Safety and preferences",
        "从时间开始安排": "Plan from the calendar",
        "这里可以切换日、周、月、年视图，也能用年份、月份和“今天”快速定位。下方概览会同步汇总当前月份。": "Switch between day, week, month and year views, or jump with the date controls and Today. The overview below follows the selected month.",
        "点一天，完成记录": "Pick a day and record it",
        "选择任意日期，就能记录出勤、请假、加班、备注和习惯打卡。现在点一下高亮的工作日试试。": "Pick any date to record attendance, leave, overtime, notes and habit check-ins. Select the highlighted workday to try it.",
        "状态、时长与批量标记": "Status, duration and bulk marking",
        "选择当天状态和时长；“更多选项”可一次标记一段日期，并自动跳过周末和法定节假日。引导不会保存这条演示记录。": "Choose a status and duration. More options can mark a date range while skipping weekends and public holidays. This tour will not save the demo record.",
        "让记录变成清晰统计": "Turn records into clear insights",
        "统计页汇总月度与年度出勤、各类请假和剩余额度。点击“统计”查看。": "Statistics summarizes monthly and yearly attendance, leave types and remaining allowances. Select Statistics to view it.",
        "把记录继续用起来": "Put your records to work",
        "点击“工具”，进入工资核算、请假条、购票提醒、习惯打卡和日历导出。": "Select Tools for payroll, leave notes, ticket reminders, habit tracking and calendar export.",
        "五个工具，覆盖高频场景": "Five tools for everyday needs",
        "出勤记录可直接核算工资、生成工资条和请假条；节假日可查看购票提醒，日常还能打卡并导出到系统日历。": "Use attendance records for payroll, payslips and leave notes; check holiday ticket reminders, track habits and export to your system calendar.",
        "先按你的工作方式设置": "Set it up for how you work",
        "在设置中填写工作制度、薪资、假期额度和购票习惯，统计与工资核算会据此自动调整。": "Add your schedule, pay, leave allowances and travel preferences. Statistics and payroll will adjust automatically.",
        "数据由你掌控": "Your data stays in your control",
        "数据默认保存在当前设备。你可以导出 CSV、同步 WebDAV，也能随时切换主题和中英文界面。到这里，核心功能就认识完了。": "Data stays on this device by default. Export CSV, sync with WebDAV, and switch theme or language anytime. You now know the essentials.",
        ...
        "个人资料": "Profile", "薪资与扣款": "Pay and deductions", "请假条模板": "Leave note template", "账号与连接": "Accounts and connections", "数据与同步": "Data and sync", "外观": "Appearance", "高级设置": "Advanced",
        "把休历中的重要安排带到你日常使用的日历和邮箱。": "Bring important RestCal plans into the calendar and email apps you use every day.",
        "Google 日历": "Google Calendar", "单向同步，Google 日历不会反向修改休历": "One-way sync; Google Calendar never changes RestCal", "未连接": "Not connected", "桌面版可用": "Desktop only",
        "记录变化后自动同步": "Sync automatically after changes", "请假与调休": "Leave and comp time", "普通出勤": "Regular attendance", "备注": "Notes", "连接 Google": "Connect Google", "立即同步": "Sync now", "断开": "Disconnect",
        "系统默认邮箱": "Default email app", "生成请假条后，可直接带着主题和正文打开邮件应用。": "After generating a leave note, open your email app with the subject and message filled in.", "可用": "Available",
        "默认收件邮箱": "Default recipient", "例如：manager@example.com": "e.g. manager@example.com", "休历只能管理由自己创建的日历事项，不读取其他 Google 日程。授权信息加密保存在本机。": "RestCal can only manage calendar events it created and does not read your other Google events. Authorization is encrypted on this device.",
        "连接 Google 日历": "Connect Google Calendar", "使用系统浏览器完成安全授权": "Authorize securely in your system browser", "Google OAuth 客户端 ID": "Google OAuth client ID", "当前开发版本需要填写一次桌面应用类型的 OAuth 客户端 ID。正式发行时可预置，普通用户无需看到此项。": "This development build needs a desktop OAuth client ID once. Release builds can include it so regular users never see this field.",
        "如何创建客户端 ID": "How to create a client ID", "在 Google Cloud Console 启用 Google Calendar API，配置 OAuth 同意屏幕，然后创建“桌面应用”类型的客户端。客户端 ID 不是密码，但请勿在此填写客户端密钥。": "Enable Google Calendar API in Google Cloud Console, configure the OAuth consent screen, then create a Desktop app client. The client ID is not a password; do not enter a client secret here.",
        "前往 Google 授权": "Continue to Google", "邮件发送": "Send by email",
        "日历与邮箱": "Calendar and email", "连接 Google、邮箱或导出日历": "Connect Google, email, or export a calendar", "导出日历文件": "Export calendar file",

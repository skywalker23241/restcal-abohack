...
(function () {
    const steps = [
        ...
        {title: "购票提醒偏好", text: "按你的出行习惯计算去程、返程和开售日。", kind: "tickets"},
